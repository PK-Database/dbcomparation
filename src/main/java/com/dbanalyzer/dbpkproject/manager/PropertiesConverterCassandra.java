...
public class PropertiesConverterCassandra {
    ...
    public void convertAndSave(MasterObject masterObject, Class cls){
        log.info("CASSANDRA:::::Saving " + masterObject.getCity() + " to db");
        switch (cls.getName()){
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableOne":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableOne(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableTwo":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableTwo(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableThree":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableThree(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableFour":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableFour(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableFive":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableFive(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableSix":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableSix(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableSeven":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableSeven(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.cassandra.entity.TableEight":
                cassandraRepositoryFactory.getRepository(cls).save(convertTableEight(masterObject));
                break;
            default:
