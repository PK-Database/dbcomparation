...
public class PropertiesConverterMongo {
    ...
    public void convertAndSave(MasterObject masterObject, Class cls){
        log.info("MONGO:::::Saving " + masterObject.getCity() + " to db");
        switch (cls.getName()){
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableOne":
                mongoRepositoryFactory.getRepository(cls).save(convertTableOne(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableTwo":
                mongoRepositoryFactory.getRepository(cls).save(convertTableTwo(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableThree":
                mongoRepositoryFactory.getRepository(cls).save(convertTableThree(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableFour":
                mongoRepositoryFactory.getRepository(cls).save(convertTableFour(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableFive":
                mongoRepositoryFactory.getRepository(cls).save(convertTableFive(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableSix":
                mongoRepositoryFactory.getRepository(cls).save(convertTableSix(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableSeven":
                mongoRepositoryFactory.getRepository(cls).save(convertTableSeven(masterObject));
                break;
            case "com.dbanalyzer.dbpkproject.mongo.entity.TableEight":
                mongoRepositoryFactory.getRepository(cls).save(convertTableEight(masterObject));
                break;
            default:
